...
figure
plot( freq/1e6, 20*log10(abs(s21)), 'k-', 'Linewidth', 2 );
grid on
...
figure
plot( freq/1e6, 20*log10(abs(s31)), 'k-', 'Linewidth', 2 );
grid on
title( 'reflection coefficient S_{31}' );
xlabel( 'frequency f / MHz' );
ylabel( 'reflection coefficient |S_{31}|' );

figure
plot( freq/1e6, 20*log10(abs(s41)), 'k-', 'Linewidth', 2 );
grid on
title( 'reflection coefficient S_{41}' );
xlabel( 'frequency f / MHz' );
ylabel( 'reflection coefficient |S_{41}|' );

% plot(freq_MHz, log_s11, 'k;S11;', freq_MHz, log_s21, 'r;S21;', freq_MHz, log_s31, 'g;S31;', freq_MHz, log_s41, 'b;S41;');

% plot(freq_MHz, log_s11, 'k;S11;')
% plot( freq_MHz, log_s21, 'r;S21;')
% figure
% plot(freq_MHz, log_s31, 'g;S31;')

% figure
% plot(freq_MHz, log_s41, 'b;S41;')
